...
public class Registration {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Registration) {
			...
			if (r != null && this.getTheStudent().getStudentId() == r.getTheStudent().getStudentId() && this.getTheOffering().getSectionNum() == r.getTheOffering().getSectionNum() && this.getTheOffering().getTheCourse().equals(r.getTheOffering().getTheCourse())) {
				return true;
			}
		}
		return false;
